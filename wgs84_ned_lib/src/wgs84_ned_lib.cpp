...
void get_pos_WGS84_from_NED (double *lat, double *lon, double *alt, double x, double y, double z, double lat_home, double lon_home, double alt_home){
	//all lat and lon input are in degrees
	//x and y in meters
	//ROS_INFO("WGS LIB: converting WGS84 to NED");
	...
	*alt = radius + alt_home + z; //z positive UP, negative DOWN, alt_home = hEll
